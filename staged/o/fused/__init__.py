...
BUILD_TARGET_IDENTIFIER="test","x86_64","any",1727608130,{'onefile': True} #<target>,<arch>,<osver>,<epoch>,<flags>

#region [fuse.include: ./pyinst_essentials.py]
#fuse:import
import datetime
#fuse:import
...
#endregion [fuse.include: ./pyinst_essentials.py]

#region [fuse.include: ./frontends.py]
# Define the main frontend-engine aswell as the class that frontends should inherit from

# main/start/launch -> Launches "second-window" applications, and starts listerners if needed
# eof/stop/terminate -> Closes "second-window" applications, and stops eventual listeners
#endregion [fuse.include: ./frontends.py]
#region [fuse.include: ./defines_frontends.py]
#region [fuse.include: ./frontends/cli.py]
#region [fuse.include: ./src/libs/fuse_legacy_ui.py]
...
#endregion [fuse.include: ./src/libs/fuse_legacy_ui.py]
#endregion [fuse.include: ./frontends/cli.py]
#region [fuse.include: ./frontends/tkinter.py]

#endregion [fuse.include: ./frontends/tkinter.py]
#endregion [fuse.include: ./defines_frontends.py]
